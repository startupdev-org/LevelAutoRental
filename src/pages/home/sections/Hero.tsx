...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-[725px] bg-fixed bg-cover bg-bottom bg-no-repeat pt-36 font-sans" style={{ backgroundImage: 'url(/lvl/bg-hero.jpg)', backgroundPosition: 'center -420px' }}>
      {/* Dark Overlay */}
