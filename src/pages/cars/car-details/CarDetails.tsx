                                                                ...
                                                                {(() => {
                                                                    ...
                                                                    return availableHours.map((hour) => (
                                                                        <button
                                                                            ...
                                                                            onMouseDown={(e) => e.stopPropagation()}
                                                                            className={`w-full px-3 py-2 text-sm rounded transition-colors text-center ${pickupTime === hour
                                        ...
                                        <div className="grid grid-cols-[7fr_3fr] gap-3 mb-4">
                                            ...
                                            <div className="relative" ref={returnCalendarRef}>
                                                <button
                                                    ...
                                                    className={`w-full flex items-center justify-center gap-2 border rounded-xl py-3 px-3 transition-colors text-sm font-medium ${!pickupDate || !pickupTime
                                                        ? 'border-gray-300 text-gray-400 cursor-not-allowed'
                                                        : returnDate
                                                            ? 'border-gray-300 text-gray-900 hover:border-gray-400'
                                                            : 'border-gray-300 text-gray-400 hover:border-gray-400'
                                            ...
                                            <div className="relative" ref={returnTimeRef}>
                                                <button
                                                    ...
                                                    className={`w-full flex items-center justify-center gap-2 border rounded-xl py-3 px-3 transition-colors text-sm font-medium ${!pickupDate || !pickupTime || !returnDate
                                                        ? 'border-gray-300 text-gray-400 cursor-not-allowed'
                                                        : returnTime
                                                            ? 'border-gray-300 text-gray-900 hover:border-gray-400'
                                                            : 'border-gray-300 text-gray-400 hover:border-gray-400'
                                                            ...
                                                            <div className="grid grid-cols-7 gap-1">
                                                                {generateCalendarDays(calendarMonth.pickup).map((day, index) => {
                                                                    ...
                                                                    return (
                                                                        <div
                                                                            key={index}
                                                                            className={`w-8 h-8 flex items-center justify-center text-xs cursor-pointer rounded transition-colors relative ${isBlocked
                                                                                ? 'text-gray-300 cursor-not-allowed'
                                                                                : 'text-gray-700'
                                                                                } ${isSelected
                                                                                    ? 'bg-theme-500 text-white hover:bg-theme-600 font-medium'
