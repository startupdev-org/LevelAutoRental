        ...
        >
            ...
            <div className="relative max-w-[1600px] mx-auto">
                ...
                <motion.div
                    ...
                    whileInView="animate"
                    viewport={{ once: true }}
                    className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-20"
                >
                    {steps.map((step, index) => (
                        ...
                        >
                            {/* Card Background */}
                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 md:p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 h-full mx-8 md:mx-0 md:w-[120%] md:-ml-[10%]">
                                {/* Number Badge */}
