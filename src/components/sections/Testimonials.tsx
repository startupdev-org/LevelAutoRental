        ...
        >
          <div className="absolute inset-y-0 left-0 flex items-center z-10">
            <motion.button
              ...
              className="hidden md:flex w-10 h-10 bg-white rounded-full shadow-md items-center justify-center text-gray-600 hover:text-blue-600 hover:shadow-lg"
          ...
          <div className="absolute inset-y-0 right-0 flex items-center z-10">
            <motion.button
              ...
              className="hidden md:flex w-10 h-10 bg-blue-600 text-white rounded-full shadow-md items-center justify-center hover:bg-blue-700"
              style={{ top: '60%', transform: 'translateY(-60%)' }}
            >
                  ...
                  <div className="mt-6 flex items-center gap-2">
                    {testimonials.map((_, index) => (
                      <button
                        ...
                        className={`${index === currentIndex ? 'w-10 bg-blue-600' : 'w-6 bg-gray-300'} h-1 rounded-full transition-all`}
