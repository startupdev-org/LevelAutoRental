...
export const reviews: Review[] = [
    ...
    },
    {
        ...
        category: 'Închiriere',
        comment: 'Experiență fantastică! Am închiriat un Mercedes și totul a fost perfect. Echipa este profesionistă, am fost reprezentați imediat și procesul a fost foarte simplu. Mașina era în stare impecabilă!'
    },
    {
        id: '14',
        userName: 'Ana Maria',
        ...
        category: 'Închiriere',
        comment: 'Recomand cu toată încrederea! Serviciu rapid, mașini noi și prețuri corecte. Am folosit serviciile de două ori deja și de fiecare dată am fost foarte mulțumită.'
    },
    {
        id: '15',
        ...
        category: 'Închiriere',
        comment: 'Excelent serviciu pentru închirieri auto în Chișinău. Oferă și livrare la domiciliu, ceea ce este foarte convenabil. Mașinile sunt îngrijite și prețurile sunt mai bune decât la concurență.'
    },
    {
        id: '16',
        userName: 'Elena Radu',
        userInitial: 'E',
        userInitialColor: 'bg-yellow-500',
        rating: 5,
        date: '3 martie 2025',
        category: 'Închiriere',
        comment: 'Am închiriat pentru weekend și am fost foarte impresionată de calitatea serviciului. Personal foarte amabil și răspunde prompt la întrebări. Mașina a fost curată și în stare perfectă de funcționare.'
    },
    {
        id: '17',
        userName: 'Petru',
        userInitial: 'P',
        userInitialColor: 'bg-orange-500',
        rating: 5,
        date: '10 martie 2025',
        category: 'Închiriere',
        comment: 'Serviciu profesionist și de încredere. Contractul este clar, fără surprize. Am închiriat de mai multe ori și de fiecare dată totul a mers perfect. Recomand!'
    },
    {
        id: '18',
        userName: 'Diana',
        userInitial: 'D',
        userInitialColor: 'bg-teal-500',
        rating: 5,
        date: '18 martie 2025',
        category: 'Închiriere',
        comment: 'Cea mai bună companie de închirieri auto din Moldova! Prețuri fair, mașini calitative și echipa super de ajutor. Will definitely use again!'
    },
    {
        id: '19',
        ...
        date: '22 martie 2025',
        category: 'Închiriere',
        comment: 'Fast service, good cars, fair prices. What more can you ask for? Highly recommend for anyone needing a rental car in Chisinau.'
    },
    {
        id: '20',
        userName: 'Alin',
        userInitial: 'A',
        userInitialColor: 'bg-cyan-500',
        rating: 5,
        date: '28 martie 2025',
        category: 'Închiriere',
