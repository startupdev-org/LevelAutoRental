...
function generateMockOrders(cars: Car[]): OrderDisplay[] {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    mockOrders.push({
      ...
      pickupTime: ['08:00 AM', '09:30 AM', '10:00 AM', '11:00 AM', '02:00 PM'][i],
      returnDate: endDate.toISOString().split('T')[0],
      returnTime: ['05:00 PM', '06:30 PM', '07:00 PM', '08:00 PM', '09:00 PM'][i],
      status: statuses[i],
      total_amount: '0',
      amount: 0,
  ...
  for (let i = 0; i < 8; i++) {
    ...
    mockOrders.push({
      ...
      avatar: car.image,
      pickupDate: startDate.toISOString().split('T')[0],
      pickupTime: ['08:00 AM', '09:00 AM', '10:30 AM', '11:00 AM', '12:00 PM', '01:00 PM', '02:30 PM', '03:00 PM'][i],
      returnDate: endDate.toISOString().split('T')[0],
      returnTime: ['05:00 PM', '06:00 PM', '07:30 PM', '08:00 PM', '09:00 PM', '10:00 PM', '11:30 PM', '12:00 PM'][i],
      status: statuses[i],
...
function generateMockRentals(cars: Car[]): OrderDisplay[] {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    mockOrders.push({
      ...
      avatar: car.image,
      pickupDate: startDate.toISOString().split('T')[0],
      pickupTime: ['08:00 AM', '09:00 AM', '10:30 AM', '11:00 AM', '12:00 PM', '01:00 PM', '02:30 PM', '03:00 PM', '09:30 AM', '10:00 AM'][i],
      returnDate: endDate.toISOString().split('T')[0],
      returnTime: ['05:00 PM', '06:00 PM', '07:30 PM', '08:00 PM', '09:00 PM', '10:00 PM', '11:30 PM', '12:00 PM', '06:30 PM', '07:00 PM'][i],
      status: statuses[i],
      total_amount: amount.toString(),
      amount: amount,
      createdAt: createdDate.toISOString(),
